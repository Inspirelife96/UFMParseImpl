...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/inspirelife@hotmail.com/UFMParseImpl'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'inspirelife@hotmail.com' => 'inspirelife@hotmail.com' }
  s.source           = { :git => 'https://github.com/inspirelife@hotmail.com/UFMParseImpl.git', :tag => s.version.to_s }
